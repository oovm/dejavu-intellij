...
import djv.intellij.language.psi.SahaNamespace;
...
public class SahaNamespaceNode extends ASTWrapperPsiElement implements SahaNamespace {

  public SahaNamespaceNode(@NotNull ASTNode node) {
    super(node);
  }
