...
import djv.intellij.language.psi.SahaRuleType;
...
public class SahaRuleTypeNode extends ASTWrapperPsiElement implements SahaRuleType {

  public SahaRuleTypeNode(@NotNull ASTNode node) {
    super(node);
  }
