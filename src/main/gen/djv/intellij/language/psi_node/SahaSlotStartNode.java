...
import djv.intellij.language.psi.SahaSlotStart;
...
public class SahaSlotStartNode extends ASTWrapperPsiElement implements SahaSlotStart {

  public SahaSlotStartNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SahaVisitor visitor) {
    visitor.visitSlotStart(this);
  }
