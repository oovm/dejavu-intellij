...
import djv.intellij.language.psi.SahaModifiers;
...
public class SahaModifiersNode extends ASTWrapperPsiElement implements SahaModifiers {

  public SahaModifiersNode(@NotNull ASTNode node) {
    super(node);
  }
