...
public class DjvSymbolPathNode extends ASTWrapperPsiElement implements DjvSymbolPath {

  public DjvSymbolPathNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<DjvKey> getKeyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, DjvKey.class);
  }
