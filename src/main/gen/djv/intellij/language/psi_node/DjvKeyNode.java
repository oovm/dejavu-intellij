...
public class DjvKeyNode extends ASTWrapperPsiElement implements DjvKey {

  public DjvKeyNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DjvKeySymbol getKeySymbol() {
    return findChildByClass(DjvKeySymbol.class);
  }
