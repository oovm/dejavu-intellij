...
import djv.intellij.language.psi.SahaCharset;
...
public class SahaCharsetNode extends ASTWrapperPsiElement implements SahaCharset {

  public SahaCharsetNode(@NotNull ASTNode node) {
    super(node);
  }
