...
public class DjvObjectItemNode extends ASTWrapperPsiElement implements DjvObjectItem {

  public DjvObjectItemNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DjvObjectKey getObjectKey() {
    return findNotNullChildByClass(DjvObjectKey.class);
  }
