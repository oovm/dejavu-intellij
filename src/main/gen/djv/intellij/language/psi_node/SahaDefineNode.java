...
import djv.intellij.language.psi.SahaDefine;
...
public class SahaDefineNode extends ASTWrapperPsiElement implements SahaDefine {

  public SahaDefineNode(@NotNull ASTNode node) {
    super(node);
  }
