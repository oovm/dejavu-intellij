...
import djv.intellij.language.psi.SahaTypeHint;
...
public class SahaTypeHintNode extends ASTWrapperPsiElement implements SahaTypeHint {

  public SahaTypeHintNode(@NotNull ASTNode node) {
    super(node);
  }
