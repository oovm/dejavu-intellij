...
public class DjvInlineElseNode extends ASTWrapperPsiElement implements DjvInlineElse {

  public DjvInlineElseNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DjvVisitor visitor) {
    visitor.visitInlineElse(this);
  }
