...
import djv.intellij.language.psi.SahaKwElse;
...
public class SahaKwElseNode extends ASTWrapperPsiElement implements SahaKwElse {

  public SahaKwElseNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SahaVisitor visitor) {
    visitor.visitKwElse(this);
  }
