...
import djv.intellij.language.psi.SahaSuffix;
...
public class SahaSuffixNode extends ASTWrapperPsiElement implements SahaSuffix {

  public SahaSuffixNode(@NotNull ASTNode node) {
    super(node);
  }
