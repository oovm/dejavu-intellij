...
import djv.intellij.language.psi.SahaKeySymbol;
...
public class SahaKeySymbolNode extends ASTWrapperPsiElement implements SahaKeySymbol {

  public SahaKeySymbolNode(@NotNull ASTNode node) {
    super(node);
  }
