...
public class DjvFieldMarkNode extends ASTWrapperPsiElement implements DjvFieldMark {

  public DjvFieldMarkNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DjvFieldRhs getFieldRhs() {
    return findNotNullChildByClass(DjvFieldRhs.class);
  }
