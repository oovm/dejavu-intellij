...
import djv.intellij.language.psi.SahaKwIn;
...
public class SahaKwInNode extends ASTWrapperPsiElement implements SahaKwIn {

  public SahaKwInNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SahaVisitor visitor) {
    visitor.visitKwIn(this);
  }
