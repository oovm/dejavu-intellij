...
import djv.intellij.language.psi.SahaPrefix;
...
public class SahaPrefixNode extends ASTWrapperPsiElement implements SahaPrefix {

  public SahaPrefixNode(@NotNull ASTNode node) {
    super(node);
  }
