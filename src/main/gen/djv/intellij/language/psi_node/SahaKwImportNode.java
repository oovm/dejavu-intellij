...
import djv.intellij.language.psi.SahaKwImport;
...
public class SahaKwImportNode extends ASTWrapperPsiElement implements SahaKwImport {

  public SahaKwImportNode(@NotNull ASTNode node) {
    super(node);
  }
