...
public class DjvMacroArgNode extends ASTWrapperPsiElement implements DjvMacroArg {

  public DjvMacroArgNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DjvMacroStatement getMacroStatement() {
    return findChildByClass(DjvMacroStatement.class);
  }
