...
import djv.intellij.language.psi.SahaExportStatement;
...
public class SahaExportStatementNode extends ASTWrapperPsiElement implements SahaExportStatement {

  public SahaExportStatementNode(@NotNull ASTNode node) {
    super(node);
  }
