...
import djv.intellij.language.psi.SahaBranchMark;
...
public class SahaBranchMarkNode extends ASTWrapperPsiElement implements SahaBranchMark {

  public SahaBranchMarkNode(@NotNull ASTNode node) {
    super(node);
  }
