...
public class DjvPairNode extends ASTWrapperPsiElement implements DjvPair {

  public DjvPairNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public DjvSymbolPath getSymbolPath() {
    return findNotNullChildByClass(DjvSymbolPath.class);
  }
