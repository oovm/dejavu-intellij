...
public class DjvExportStatementNode extends ASTWrapperPsiElement implements DjvExportStatement {

  public DjvExportStatementNode(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DjvObject getObject() {
    return findChildByClass(DjvObject.class);
  }
