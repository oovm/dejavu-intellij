...
import djv.intellij.language.psi.SahaCommentDoc;
...
public class SahaCommentDocNode extends ASTWrapperPsiElement implements SahaCommentDoc {

  public SahaCommentDocNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SahaVisitor visitor) {
    visitor.visitCommentDoc(this);
  }
