...
import djv.intellij.language.psi.SahaTextStatement;
...
public class SahaTextStatementNode extends ASTWrapperPsiElement implements SahaTextStatement {

  public SahaTextStatementNode(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SahaVisitor visitor) {
    visitor.visitTextStatement(this);
  }
