...
import djv.intellij.language.psi.SahaMacroCall;
...
public class SahaMacroCallNode extends ASTWrapperPsiElement implements SahaMacroCall {

  public SahaMacroCallNode(@NotNull ASTNode node) {
    super(node);
  }
