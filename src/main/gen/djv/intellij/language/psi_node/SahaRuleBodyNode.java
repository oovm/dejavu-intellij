...
import djv.intellij.language.psi.SahaRuleBody;
...
public class SahaRuleBodyNode extends ASTWrapperPsiElement implements SahaRuleBody {

  public SahaRuleBodyNode(@NotNull ASTNode node) {
    super(node);
  }
