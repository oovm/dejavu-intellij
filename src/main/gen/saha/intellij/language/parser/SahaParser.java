...
package saha.intellij.language.parser;
...
public class SahaParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // statements*
  static boolean Saha(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "Saha")) return false;
    while (true) {
      int c = current_position_(b);
      if (!statements(b, l + 1)) break;
      if (!empty_element_parsed_guard_(b, "Saha", c)) break;
    }
    return true;
  }
  ...
  public static boolean function_call(PsiBuilder b, int l) {
    ...
    r = consumeToken(b, AT);
    r = r && identifier(b, l + 1);
    r = r && parenthesis(b, l + 1, SahaParser::expr, COMMA_parser_);
  ...
  public static boolean macro_statement(PsiBuilder b, int l) {
    ...
    r = r && parenthesis(b, l + 1, SahaParser::macro_arg, COMMA_parser_);
  ...
  public static boolean table(PsiBuilder b, int l) {
    ...
    r = table_0(b, l + 1);
    r = r && paired(b, l + 1, SahaParser::table_inner);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
