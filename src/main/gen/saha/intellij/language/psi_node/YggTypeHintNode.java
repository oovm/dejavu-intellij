...
import saha.intellij.language.psi.YggTypeHint;
import saha.intellij.language.psi.YggVisitor;
import ygg.intellij.language.psi.*;

public class YggTypeHintNode extends ASTWrapperPsiElement implements YggTypeHint {

  public YggTypeHintNode(@NotNull ASTNode node) {
    super(node);
  }
